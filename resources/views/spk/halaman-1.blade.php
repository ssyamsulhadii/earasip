...
<div style="text-align: center">Nomor : 800/ 169 /P3I/BKPSDM/2025</div>
<div class="text-justify">
    Pada hari ini <b>Senin</b> tanggal <b>Satu</b> bulan <b>Desember</b> tahun <b>Dua Ribu
        Dua Puluh Lima</b>, yang bertanda tangan di bawah ini :
</div>
<table>
    <tr>
...
<table>
    <tr>
        ...
        <td>: 1 November 2025 s/d 31 Oktober 2026</td>
    </tr>
    <tr>
        <td class="label">Jabatan</td>
        {{-- <td>: {{ $user->jabatan }}</td> --}}
...
<table>
    <x-pdf.tr num="1"
        text="<strong>Pihak Kesatu</strong> membuat dan menetapkan tugas pekerjaan yang harus dilaksanakan oleh <strong>Pihak Kedua</strong> selama masa
    Perjanjian Kerja.">
    </x-pdf.tr>
    <x-pdf.tr num="2"
        text="<strong>Pihak Kedua</strong> wajib melaksanakan tugas pekerjaan yang diberikan <strong>Pihak Kesatu</strong> dengan sebaik-baiknya
